...
<html lang="en">
    <head>
        ...
        <title>编程书目</title>
        <meta name="description" content="Leaf is a beautiful Bootstrap 4 template for app landing pages." /> 
            ...
            <div class="container-fluid">
                <div class="row vh-md-100">
                    <div class="col-md-5 mx-auto my-auto p-5 p-md-0 order-2 order-md-1">
                        ...
                        <ul class="features-list mb-3">
                            <li>作  者：Magnus Lie Hetland</li>
                            <li>书　号：978-7-115-47488-9</li>
                            <li>出版社：人民邮电出版社</li>
                            <li>佑币额：10</li>
                        </ul>
                        <a href="#" class="btn btn-info">下载</a>
                    ...
                    <div class="col-md-6 py-5 bg-info order-1 order-md-2">
                        <img src="img/book2.jpg" class="img-fluid img-app d-block mx-auto" alt="App 2"/>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="row vh-md-100">
                    <div class="col-md-6 py-5 bg-secondary">
                        <img src="img/book3.jpg" class="img-fluid img-app d-block mx-auto" alt="App 3"/>
                    </div>
                    <div class="col-md-5 mx-auto my-auto p-5 p-md-0 order-2 order-md-1">
                        <h2>《HTML5从入门到精通</h2>
                        <p class="lead text-muted">
                            系统、全面地讲解了HTML语言及其最新版本HTML5的新功能与新特性，技术新颖实用。书中所有知识点均结合实例进行讲解，方便读者动手实践。
                        </p>
                        <ul class="features-list mb-3">
                            <li>作  者：明日科技</li>
                            <li>书　号：978-7-302-28758-2</li>
                            <li>出版社：清华大学出版社</li>
                            <li>佑币额：10</li>
                        </ul>
                        <a href="#" class="btn btn-info">下载</a>
