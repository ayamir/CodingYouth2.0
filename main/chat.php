...
$sql_select = "select * from post order by post_id desc";
$sql_select_result = mysqli_query($connect, $sql_select);
if (!$sql_select_result) {
    die("数据库查询失败：" . mysqli_error($connect));
} else {
?>
<body>
<!-- tt-mobile menu -->
    ...
    <div class="container">
        <div class="tt-topic-list">
            <div class="tt-list-header">
                ...
                <div class="tt-col-category">发帖人</div>
                <div class="tt-col-value hide-mobile">标签</div>
                <div class="tt-col-value hide-mobile">点赞数</div>
                <div class="tt-col-value hide-mobile">回复数</div>
                <div class="tt-col-value hide-mobile">赞赏数</div>
                <div class="tt-col-value">发布时间</div>
            </div>
            <?php
            while ($row = mysqli_fetch_assoc($sql_select_result)) {
                $post_owner_id = $row['post_owner_id'];
                $post_owner_image_path = mysqli_fetch_assoc(mysqli_query($connect, "select image_path from user where id = '".$post_owner_id."'"))['image_path'];
                $post_owner_name = $row['post_owner_name'];
                $title = $row['post_title'];
                $post_tag = $row['post_tag'];
                $reply_num = $row['post_reply_num'];
                ...
                <div class="tt-item tt-itemselect">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="post.php?post_title=<?php echo $title; ?>&post_owner_id=<?php echo $post_owner_id; ?>">
                                <?php echo $title; ?>
                            </a></h6>
                    ...
                    <div class="tt-col-value hide-mobile">
                        <span class="tt-badge tt-color15">
                            <?php echo $post_tag; ?>
                        </span>
                    </div>
                    <div class="tt-col-value hide-mobile">
