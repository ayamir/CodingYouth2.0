...
$name = $user_info['name'];
$id = $user_info['id'];
$point = mysqli_fetch_assoc(mysqli_query($connect, "select point from sign where user_id = '".$id."'"))['point'];
?>
<html lang="zh">
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../deposite/css/style.css">
    <link rel="stylesheet" type="text/css" href="../page-deposit-money-css/amazeui.min.css" />
    <link rel="stylesheet" type="text/css" href="../page-deposit-money-css/main.css" />
</head>
<body>
<!-- tt-mobile menu -->
...
<div class="pay" style=" box-shadow: 2px 2px 20px 20px rgba(0, 0, 0, 0.15); ">
	<!--主内容开始编辑-->
	<div class="tr_recharge" style="border-radius:25px;-moz-border-radius:25px;">
		<div class="tr_rechtext">
			<p class="te_retit"><img src="../images/coin.png" alt="" />充值中心</p>
			<p>1.佑币是佑思编程网中的虚拟货币，您可以使用佑币购买站内的教学资源。</p>
			<p>2.佑币与人民币换算为1：1，即1元=1佑币，您可以选择支付宝或者是微信的付款方式来进行充值。</p>
		</div>
		<form action="" class="am-form" id="doc-vld-msg">
			<div class="tr_rechbox">
				<div class="tr_rechhead">
					...
					<div class="tr_rechheadcion">
						...
						<span>当前余额：<span><?php echo $point; ?>佑币</span></span>
					</div>
				</div>
				...
				<div class="tr_rechcho am-form-group">
					...
					<label class="am-radio">
							<input type="radio" name="radio1" value="" data-am-ucheck required data-validation-message="请选择一种充值方式"><img src="../images/wechatpay.png" alt="">
						</label>
					<label class="am-radio" >
							<input type="radio" name="radio1" value="" data-am-ucheck data-validation-message="请选择一种充值方式"><img src="../images/zfbpay.png" alt="">
						</label>
				</div>
			...
			<div class="tr_paybox">
				<input type="submit" value="确认支付" class="tr_pay am-btn" style="border-radius:25px;
	-moz-border-radius:25px;">
				<span>温馨提示：佑币只限于在佑思编程网中使用，遇到问题请拨打联系电话。</span>
			</div>
		</form>
	</div>
</div>

<script type="text/javascript" src="../page-deposit-money-js/jquery.min.js"></script>
<script type="text/javascript" src="../page-deposit-money-js/ui-choose.js"></script>
