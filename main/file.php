...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../page-files-css/thumbs-embedded.css">
    <link rel="stylesheet" type="text/css" href="../page-files-css/responsive.css">
    <link rel="stylesheet" type="text/css" href="../page-files-css/color.css">
    <!--article-->
</head>
    ...
    <div class="container">
        <div class="tt-tab-wrapper">
                ...
                <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link show active" data-toggle="tab" href="#tt-tab-01"
                           role="tab"><span>文章</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-02" role="tab"><span>视频</span></a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                <!--文章-->
                <?php
                $sql_select = "select * from article order by article_id desc";
                                ...
                                <div class="row">
                                    ...
                                    <div class="span8 main-listing">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $sub_content = mb_substr($article_content, 0, 14);
                                            ...
                                            <article class="format-standard type-post hentry clearfix">
                                                <header class="clearfix">
                                                    <h3 class="post-title">
                                                        <a href="<?php echo "article.php?article_title=" . $article_title ?>&article_owner_id=<?php echo $article_owner_id; ?>">
                ...
                <!--视频-->
                <?php
                $select_videos = "select * from video order by video_id desc";
                $select_videos_result = mysqli_query($connect, $select_videos);
                if (!$select_videos_result) {
                    die("读取视频数据出错：" . mysqli_error($connect));
                } else { ?>
                                    ...
                                    <div class="container">
                                        <div class="vidz_sec">
                                            ...
                                            <div class="vidz_list">
                                                <div class="row">
                                                    <?php
                                                    while ($row = mysqli_fetch_assoc($select_videos_result)) {
                                                        $video_owner_id = $row['video_owner_id'];
                                                        $video_name = $row['video_name'];
                                                        $video_title = $row['video_title'];
                                                        $video_duration = $row['video_duration'];
                                                        $video_owner_name = $row['video_owner_name'];
                                                        $visit_time = $row['visit_num'];
                                                        $video_time = $row['video_time'];
                                                        $path = $row['video_path'];
                                                        $cover_path = $row['cover_path'];
                                                        // 封面
                                                        ?>
                                                        <div class="col-lg-4 col-md-6 col-sm-6 col-6 full_wdth">
                                                            <div class="video">
                                                                <div class="vid_thumbainl">
                                                                    <a href="<?php echo "video.php?video_title=" . $video_title ?>&video_owner_id=<?php echo $video_owner_id; ?>">
                                                                        <img src="./upload_cover/<?php echo $cover_path; ?>" alt="" style="height: 108px" width="192">
                                                                    </a>
                                                                </div>
                                                                <a href="<?php echo "video.php?video_title=" . $video_title ?>&video_owner_id=<?php echo $video_owner_id; ?>">
                                                                ...
                                                                <div class="video_info">
                                                                    <h3>
                                                                        <a href="<?php echo "video.php?video_title=" . $video_title ?>&video_owner_id=<?php echo $video_owner_id; ?>"
                                                                           title="">
                                                                            <?php echo $video_title ?></a></h3>
                                                                    <h4><a href="" title="">
                                                                            <?php echo $video_owner_name ?>
                                                                        </a></h4>
                                                                    <span><?php echo $visit_time . " views.  "; ?><small
                                                                                class="posted_dt"><?php echo $video_time; ?></small></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php
...
<script src="../page-files-js/jquery.min.js"></script>
<script src="../page-files-js/popper.js"></script>
<script src="../page-files-js/bootstrap.min.js"></script>
<script src="../page-files-js/flatpickr.js"></script>
<script src="../page-files-js/script.js"></script>
