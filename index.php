...
<head>
    ...
    <link rel="stylesheet" href="page-index/css/style.css">
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="page-index/vendor/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="page-index/vendor/font-awesome/css/font-awesome.min.css">
    <!-- Google fonts - Roboto-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,700">
    <!-- Bootstrap Select-->
    <link rel="stylesheet" href="page-index/vendor/bootstrap-select/css/bootstrap-select.min.css">
    <!-- owl carousel-->
    <link rel="stylesheet" href="page-index/vendor/owl.carousel/assets/owl.carousel.css">
    <link rel="stylesheet" href="page-index/vendor/owl.carousel/assets/owl.theme.default.css">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="page-index/css/style.default.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="page-index/css/custom.css">
    <!-- Favicon and apple touch icons-->
    <link rel="apple-touch-icon" href="page-index/img/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="57x57" href="page-index/img/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="72x72" href="page-index/img/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="page-index/img/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="page-index/img/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="page-index/img/apple-touch-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="page-index/img/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="page-index/img/apple-touch-icon-152x152.png">
    ...
    <div class="container">
        <div class="row tt-row no-gutters">
            <div class="col-auto">
                ...
                <div class="tt-logo">
                    <a href=""><img src="./pic/logo.jpg" alt="" class="image1"></a>
                </div>
                <div class="tt-desktop-menu">
                    <nav>
                        <ul>
                            ...
                            <li><a href="./main/file.php"><span>佑教学</span></a></li>
                            <li><a href="./main/chat.php"><span>佑交流</span></a></li>
                                <li><a href="./main/knowledge_lib.php"><span>佑知识</span></a>
                                    <ul style="opacity: 0.85; background-color: #f5dc7d; -webkit-border-bottom-left-radius: 15px; -webkit-border-bottom-right-radius: 15px; box-shadow: 2px 2px 20px 20px rgba(0, 0, 0, 0.15);">
                                        <li><a href="./main/knowledge_frame.php">学习框架</a></li>
            ...
            <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] === true) {?>
                <div class="col-auto ml-auto">
                    <div class="tt-account-btn">
                        <a href="./main/logout.php" class="btn btn-primary" style="border-radius: 15px">登出</a>
                        <a href="./main/user.php" class="btn btn-secondary" style="border-radius: 15px">个人</a>
                    </div>
                </div>
            <?php } else { ?>
                <div class="col-auto ml-auto">
                    <div class="tt-account-btn">
                        <a href="./login/login.php" class="btn btn-primary" style="border-radius: 15px">登录</a>
                        <a href="./sign_up/register.php" class="btn btn-secondary" style="border-radius: 15px">注册</a>
                    </div>
                </div>
            <?php } ?>
        </div>
...
<section style=" background-size: cover;" class="relative-positioned">
    <!-- Carousel Start-->
    <div class="home-carousel">
        ...
        <div class="container">
            <div class="homepage owl-carousel">
                <div class="item">
                    <div class="row">
                        <div class="col-md-7 text-center"><img src="img/font01.png"width="400"height="400" ></div>
                        <div class="col-md-5">
                            <br><br><br><br>
                            <h1><strong>佑思编程教育</strong></h1><br><h3>——轻便高效的编程教育平台</h3>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        <div class="col-md-5 text-right">
                            <br><br><br>
                            <h1><strong>巧学编程，乐学编程</strong></h1><br>
                            <h3><strong>开始您的编程之旅</strong></h3>
                        </div>
                        <div class="col-md-7"><img src="img/front02.png"width="375" height="400"></div>
                    </div>
                </div>
            </div>
        </div>
...
<div style=" background-size: cover;" class="jumbotron relative-positioned color-white text-md-center">
    <div class="dark-mask mask-primary"></div>
    <div class="container">
        <div class="row mb-small">
            <div class="col-md-12 text-center">
                <h1 class="text-uppercase">佑思编程教育网</h1>
                <h2 class="text-uppercase">一个高效简洁的编程教育平台</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-small"><img src="page-index/img/front01.png" alt="..." width="400" height="400"> </div>
            <div class="col-md-6 text-center-sm">
                <p class="text-uppercase text-bold">寓教于乐 乐有所思 思有所得</p>
                <p class="no-letter-spacing">Coding in youth is amazing in truth</p>
                <p><a href="login/login.php" class="scroll-to btn btn-template-outlined-white">JOIN US</a></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row portfolio-showcase">
                    <div class="col-md-6">
                        <div class="image"><img src="page-index/img/intro.jpg" alt="" class="img-fluid"></div>
                    </div>
                    <div class="col-md-6">
                        <h3><a href="">佑思编程网</a></h3>
                        <p class="lead">打造致力于青少年编程学习的平台</p>
                        <p><strong>青年化的编程平台</strong><br>富有生机与活力的编程社区，许许多多同龄人与你一起学习进步，让你的编程学习不孤独。
                            <br><strong>年轻活力的大学生师资</strong><br>更年轻的老师，更亲切的交流,更懂你的心。</p>
                        <p class="buttons"><a href="#" class="btn btn-template-outlined">JOIN</a><a href="#" class="btn btn-template-outlined">MORE</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="box-simple">
                    <div class="icon-outlined"><i class="fa fa-play"></i></div>
                    <h3 class="h4">视频</h3>
                    <p>这么有趣的视频你佑吗？</p>
                </div>
            </div>
...
<section class="bar background-white no-mb">
    <div class="container">
        <div class="col-md-12">
            ...
            <p class="lead">这里有简单实用的编程教学视频，时长小，内容精，充分利用您的碎片时间。 <a href="login/login.php">Check our work!</a></p>
            <div class="row">
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="page-index/img/portfolio-4.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="login/login.php" class="btn btn-template-outlined-white"><i class="fa fa-play"> </i> More</a></div>
                        </div>
                        <div class="text">
                            <h4><a href="login/login.php">用C语言计算两个数之间绝对值 </a></h4>
                            <p class="author-category">By <a href="login/login.php">佑思编程</a> in <a href="login/login.php">C语言</a></p>
                            <p class="intro">C语言与数学相结合，编程求解两个数之间的绝对值问题。</p><a href="login/login.php" class="btn btn-template-outlined">点击观看</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="page-index/img/portfolio-3.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="login/login.php" class="btn btn-template-outlined-white"><i class="fa fa-play"> </i>More</a></div>
                        </div>
                        <div class="text">
                            <h4><a href="login/login.php">python输出函数介绍</a></h4>
                            <p class="author-category">By <a href="login/login.php">Xinfeng</a> in <a href="login/login.php">python</a></p>
                            <p class="intro">print()输出函数的介绍，其用于打印输出，是最常见的一个函数</p><a href="login/login.php" class="btn btn-template-outlined">点击观看</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="page-index/img/portfolio-5.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="login/login.php" class="btn btn-template-outlined-white"><i class="fa fa-play"> </i> More </a></div>
                        </div>
                        <div class="text">
                            <h4><a href="login/login.php">HTML 变网页</a></h4>
                            <p class="author-category">By <a href="login/login.php">痴迷C的石老师</a> in <a href="login/login.php">HTML</a></p>
                            <p class="intro">用HTML编一个非常简单的网页。</p><a href="login/login.php" class="btn btn-template-outlined">点击观看</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home-blog-post">
                        <div class="image"><img src="page-index/img/portfolio-6.jpg" alt="..." class="img-fluid">
                            <div class="overlay d-flex align-items-center justify-content-center"><a href="login/login.php" class="btn btn-template-outlined-white"><i class="fa fa-play"> </i> More </a></div>
                        </div>
                        <div class="text">
                            <h4><a href="login/login.php">python入门介绍</a></h4>
                            <p class="author-category">By <a href="login/login.php">Xinfeng</a> in <a href="login/login.php">python</a></p>
                            <p class="intro">这个视频规划了一份详细的python学习路线，帮助您入门python，让您少走弯路。</p><a href="login/login.php" class="btn btn-template-outlined">点击观看</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="get-it">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 text-center p-3">   <a href="#" class="btn btn-template-outlined-white">JOIN US</a></div>
        </div>
    </div>
</div>
<!-- FOOTER -->
<footer class="main-footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <h4 class="h6">关于我们</h4>
                <p>一个以大学生为主体的编程教育平台</p>
                <hr>
                <h4 class="h6">加入我们的每月订阅</h4>
                <form>
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled footer-blog-list">
                    <li class="d-flex align-items-center">
                        <div class="image"><img src="page-index/img/logobilibili.png" alt="..." class="img-fluid"></div>
                        <div class="text">
                            <h5 class="mb-0"> <a href="login/login.php">佑思编程网</a></h5>
                        </div>
                    </li>
                    <li class="d-flex align-items-center">
                        <div class="image"><img src="page-index/img/logoweibo.png" alt="..." class="img-fluid"></div>
                        <div class="text">
                            <h5 class="mb-0"> <a href="login/login.php">@佑思编程</a></h5>
                        </div>
                    </li>
                    <li class="d-flex align-items-center">
                        <div class="image"><img src="page-index/img/logowechat.png" alt="..." class="img-fluid"></div>
                        <div class="text">
                            <h5 class="mb-0"> <a href="login/login.php">公众号：佑思编程</a></h5>
                        </div>
                    </li>
                </ul>
                <hr class="d-block d-lg-none">
            ...
            <div class="col-lg-3">
                <h4 class="h6">联系地址</h4>
                <p class="text-uppercase"><strong>北京市</strong><br>西土城路 <br>北京邮电大学 </p><a href="contact.html" class="btn btn-template-main">CONTACT US</a>
                <hr class="d-block d-lg-none">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 text-center-md">
                    <p>&copy; 2019-2020.佑思编程教育网<br> © All Rights Reserved</p>
                </div>
                <div class="col-lg-8 text-right text-center-md">
                    <p>佑思编程网<a href="http://www.codingyouth.com/" target="_blank"></a><br>京ICP备20004954号</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Javascript files-->
<script src="page-index/vendor/jquery/jquery.min.js"></script>
<script src="page-index/vendor/bootstrap/js/bootstrap.min.js"></script>
<script src="page-index/vendor/jquery.cookie/jquery.cookie.js"> </script>
<script src="page-index/vendor/owl.carousel/owl.carousel.min.js"></script>
<script src="page-index/js/front.js"></script>
