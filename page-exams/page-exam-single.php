...
$image_path = mysqli_fetch_assoc(mysqli_query($connect, "select * from user where number = '".$number."'"))['image_path'];
?>
<html lang="zh">
<head>
                        ...
                        <ul>
                            ...
                            <li><a href="../main/knowledge_lib.php"><span>佑知识</span></a>
                                <ul style="opacity: 0.85; background-color: #f5dc7d; -webkit-border-bottom-left-radius: 15px; -webkit-border-bottom-right-radius: 15px; box-shadow: 2px 2px 20px 20px rgba(0, 0, 0, 0.15); border: #1cbbb4; ">
                                    <li><a href="../main/knowledge_frame.php"><span>学习框架</span></a> </li>
            ...
            <div class="col-auto ml-auto">
                <div class="tt-user-info d-flex justify-content-center">
                    <div class="tt-avatar-icon tt-size-md">
                        <a href="../main/user.php" class="tt-btn-icon">
                            <?php
                            ...
                            <?php } else { ?>
                                <img src="<?php echo "../main/" . $image_path;  ?>" alt="" class="image">
                            <?php } ?>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="test_title">
                        ...
                        <div class="test_content">
                            <div class="test_content_title">
                                <h2>单选题</h2>
                                <p>
                                    <span>共</span><i class="content_lit">3</i><span>题，</span><span>合计</span><i class="content_fs">30</i><span>分</span>
                                </p>
                            </div>
                        </div>
                            ...
                            <ul>
                                    <li id="qu_0_0">
                                        <div class="test_content_nr_tt">
                                            <i>1</i><span>(10分)</span><font>C＋＋程序的三种基本结构是( )</font>
                                        </div>
                                            ...
                                            <ul>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_1_option_1">
                                                            A.
                                                    <p class="ue" style="display: inline;">顺序结构、选择结构、循环结构</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_1_option_2">
                                                            B.
                                                    <p class="ue" style="display: inline;">递归结构、循环结构、转移结构</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_1_option_3">
                                                            C.
                                                    <p class="ue" style="display: inline;">嵌套结构、递归结构、顺序结构</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_1_option_4">
                                                            D.
                                                    <p class="ue" style="display: inline;">循环结构、转移结构、顺序结构</p>
                                                    </label>
                                                    </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li id="qu_0_1">
                                        <div class="test_content_nr_tt">
                                            <i>2</i><span>(10分)</span><font>编写C++程序一般需经过的几个步骤依次是（）</font>
                                        </div>
                                        <div class="test_content_nr_main">
                                            <ul>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_2_option_1">
                                                            A.
                                                    <p class="ue" style="display: inline;">编辑、调试、编译、连接</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_2_option_2">
                                                            B.
                                                    <p class="ue" style="display: inline;">编辑、编译、连接、运行</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_2_option_3">
                                                            C.
                                                    <p class="ue" style="display: inline;">编译、调试、编辑、连接</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_2_option_4">
                                                            D.
                                                    <p class="ue" style="display: inline;">编译、编辑、连接、运行</p>
                                                    </label>
                                                    </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li id="qu_0_2">
                                        <div class="test_content_nr_tt">
                                            <i>3</i><span>(10分)</span><font>决定C++语言中函数的返回值类型的是（）</font>
                                        </div>
                                        <div class="test_content_nr_main">
                                            <ul>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_3_option_1">
                                                            A.
                                                    <p class="ue" style="display: inline;">return语句中的表达式类型</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_3_option_2">
                                                            B.
                                                    <p class="ue" style="display: inline;">调用该函数时系统随机产生的类型</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    ...
                                                    <label for="0_answer_3_option_3">
                                                            C.
                                                    <p class="ue" style="display: inline;">调用该函数时的主调用函数类型</p>
                                                    </label>
                                                    </li>
                                                <li class="option">
                                                    <input type="radio" class="radioOrCheck" name="answer3"id="0_answer_3_option_4"/>
                                                    <label for="0_answer_3_option_4">
                                                            D.
                                                    <p class="ue" style="display: inline;">在定义该函数时所指定的数据类型</p>
                                                    </label>
                                                    </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="test_content_nr">
                            <ul>
                                    <li id="qu_1_0">
                                        <div class="test_content_nr_tt">
                                            <i>1</i><span>(10分)</span><font>下面叙述正确的是（）</font>
                                        </div>
                                        <div class="test_content_nr_main">
                                        <ul>
                                            <li class="option">
                                                ...
                                                <label for="1_answer_1_option_1">
                                                            A.
                                                <p class="ue" style="display: inline;">派生类一般都用公有派生</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                ...
                                                <label for="1_answer_1_option_2">
                                                            B.
                                                <p class="ue" style="display: inline;">对基类成员的访问必须是无二义性的</p></label>
                                            </li>
                                            <li class="option">
                                                <input type="checkbox" class="radioOrCheck" name="answer1" id="1_answer_1_option_3"/>
                                                <label for="1_answer_1_option_3">
                                                            C.
                                                <p class="ue" style="display: inline;">赋值兼容规则也适用于多重继承的组合</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                ...
                                                <label for="1_answer_1_option_4">
                                                            D.
                                                <p class="ue" style="display: inline;">基类的公有成员在派生类中仍然是公有的</p>
                                                </label>
                                            </li>
                                    ...
                                    <li id="qu_1_0">
                                        <div class="test_content_nr_tt">
                                            <i>2</i><span>(10分)</span><font>下列能作为类的成员的是（）</font>
                                        </div>
                                        <div class="test_content_nr_main">
                                        <ul>
                                            <li class="option">
                                                ...
                                                <label for="1_answer_2_option_1">
                                                            A.
                                                <p class="ue" style="display: inline;">自身类对象的指针</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                            ...
                                            <li class="option">
                                                ...
                                                <label for="1_answer_2_option_4">
                                                            D.
                                                <p class="ue" style="display: inline;">另一个类的对象</p>
                                                </label>
                                            </li>
                                    ...
                                    <li id="qu_1_0">
                                        <div class="test_content_nr_tt">
                                            <i>3</i><span>(10分)</span><font>使用地址作为实参传给形参，下列说法不正确的是（）</font>
                                        </div>
                                        <div class="test_content_nr_main">
                                        <ul>
                                            <li class="option">
                                                ...
                                                <label for="1_answer_3_option_1">
                                                            A.
                                                <p class="ue" style="display: inline;">实参是形参的备份</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                            ...
                                            <li class="option">
                                                ...
                                                <label for="1_answer_3_option_4">
                                                            D.
                                                <p class="ue" style="display: inline;">实参与形参是同一对象</p>
                                                </label>
                                            </li>
                ...
                <div class="rt_nr1">
                    ...
                    <div class="rt_nr1_title">
                        ...
                        <div class="site-demo-button" id="layerDemo">
                            <button data-method="notice" class="layui-btn">交卷</button>
                            </div>
                </div>
      ...
      var active = {
       ...
       ,notice: function(){
          ...
          layer.open({
            ...
            ,btn: ['提交并查看答案', '不，我再检查一下']
            ,btnAlign: 'c'
            ,moveType: 1 //拖拽模式，0或者1
            ,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">确认交卷？</div>'
            ,success: function(layero){
              var btn = layero.find('.layui-layer-btn');
              btn.find('.layui-layer-btn0').attr({
                href: 'page-exam-answer.html'
                ,target: '_blank'
              });
            }
          });
