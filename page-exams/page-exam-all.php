...
<div class="line-and-laboratory">
	<div class="container">
        <div class="clearfix text-center item-header">
            ...
            <span class="text-center item-title">知识小测</span>
            <span class="line"></span>
        </div>
					...
					<a href="page-exam-single.php">
                        <div class="path-item">
                            ...
                            <div class="desc-layer">
                                <div class="center">新手入门检验您IT相关的知识基础。</div>
                            </div>
                        </div>
					</a>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="page-exam-single.php">
                        <div class="path-item">
                            ...
                            <div class="col-xs-7 col-sm-8">
                                <div class="path-name">Python</div>
                                <div class="path-course-num">
                                    </span>8</span>
                                    道试题
                                </div>
                            ...
                            <div class="desc-layer">
                                <div class="center">Python基础语法检验</div>
                            </div>
                        </div>
					</a>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="page-exam-single.php">
                        <div class="path-item">
                            ...
                            <div class="desc-layer">
                                <div class="center">包含对c++基本变量类型、循环结构等测试。</div>
                            </div>
                        </div>
					</a>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
					<a href="page-exam-single.php">
                        <div class="path-item">
                            ...
                            <div class="desc-layer">
                                <div class="center">包含对HTML、CSS、JavaScript、jQuery、HTML5等基础知识的测试。</div>
                            </div>
                        </div>
					</a>
                </div>
