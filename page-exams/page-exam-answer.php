...
<main>
    <form id="exam" class="layui-form" onsubmit="return false;">
        <div id="vue-div" class="layui-container">
            <br><br><br><br>
            <div class="layui-row layui-col-space10">
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
                           <div class="layui-card">
                               <div class="layui-card-header">
                                   <span class="green">单选第1题 答案为（A）</span></div> 
                                   <div class="layui-card-body H">
                                       <div class="layui-form-item">
                                解析
                            </div> 
                            <div class="layui-form-item">
                                    <div>C＋＋程序的三种基本结构是顺序结构、选择结构、循环结构</div>
                            </div> 
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
                    <div class="layui-card">
                        <div class="layui-card-header">
                            <span class="green">单选第2题 答案为（B）</span>
                        </div> 
                        <div class="layui-card-body H">
                            <div class="layui-form-item">
                                解析
                            ...
                            <div class="layui-form-item">
                                    <div>经过编辑、编译、连接和运行四个步骤。<br>
                                        编辑是将C++源程序输入计算机的过程，保存文件名为cpp。<br>
                                        编译是使用系统提供的编译器将源程序cpp生成机器语言的过程，目标文件为obj，由于没有得到系统分配的绝对地址，还不能直接运行。<br>
                                        连接是将目标文件obj转换为可执行程序的过程，结果为exe。运行是执行exe，在屏幕上显示结果的过程。
                                    </div>
                            </div> 
                        </div>
                    </div>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
                    <div class="layui-card">
                        <div class="layui-card-header">
                            <span class="green">单选第3题 答案为（D）</span></div> 
                            <div class="layui-card-body H">
                                <div class="layui-form-item">
                                解析
                            </div> 
                            <div class="layui-form-item">
                                    <span>函数的返回值类型由定义函数时的指定的数据类型决定的。A项的表达式的值要转换成函数的定义时的返回类型</span>
                            </div> 
                        </div>
                    </div>
                </div>
            ...
            <div class="layui-row layui-col-space10">
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
                           <div class="layui-card">
                               <div class="layui-card-header">
                                   <span class="green">多选第1题 答案为（ABC）</span></div> 
                                   <div class="layui-card-body H">
                                       <div class="layui-form-item">
                                解析
                            </div> 
                            <div class="layui-form-item">
                                <div>继承方式有三种：公有、私有和保护。<br>
                                    多继承中，多个基类具有同名成员，在它们的子类中访问这些成员，就产生了二义性，但进行访问时，不能存在二义性。<br>赋值兼容规则是指派生类对象可以当作基类对象使用，只要存在继承关系，所以单继承或多继承都适用。<br>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
                    <div class="layui-card">
                        <div class="layui-card-header">
                            <span class="green">单选第2题 答案为（ACD）</span>
                        </div> 
                        <div class="layui-card-body H">
                            <div class="layui-form-item">
                                解析
                            ...
                            <div class="layui-form-item">
                                <div>类的定义，如果有自身类对象，使得循环定义，B项错误。在类中具有自身类的指针，可
                                    以实现链表的操作，当然也可以使用对象的引用。类中可以有另一个类的对象，即成员对象。
                                </div>
                            </div> 
                        </div>
                    </div>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md4">
                    <div class="layui-card">
                        <div class="layui-card-header">
                            <span class="green">多选第3题 答案为（ABC）</span></div> 
                            <div class="layui-card-body H">
                                <div class="layui-form-item">
                                解析
                            </div> 
                            <div class="layui-form-item">
                                    <span>地址作为实参，表示实参与形参代表同一个对象。如果实参是数值，形参也是普通
                                        变量，此时形参是实参的备份。所以只有D项正确。
                                    </span>
                            </div> 
                        </div>
                    </div>
        ...
        <div class="submit">
            <a href="page-exam-single.php">返回 </a>
        </div>
    </form>
</main>
</body>
...
<script src="data/danxuan.js"></script>
<script src="data/duoxuan.js"></script>
